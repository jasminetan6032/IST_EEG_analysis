...
save_filedir =  'C:\Github\IST_EEG_analysis\Regression_results\Condition\Pz_test\';
...
for part = 1:22
    ...
    participants(part).lm= fitlm(tbl,'interactions','ResponseVar','Pz_amplitude','PredictorVars',{'pCorrect', 'condition'},'CategoricalVars','condition');
    
    
end

    save([save_filedir 'Pz_condition_regression_results.mat'], 'participants', '-v7.3');
    
    figname = [save_filedir 'Pz_condition_interaction_betas.png'];
outputname = [save_filedir 'Pz_condition_interaction_results.mat'];
