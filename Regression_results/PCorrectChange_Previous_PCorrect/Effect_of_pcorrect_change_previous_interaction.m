...
for part = 1:22
    ...
    participants(part).lm= fitlm(tbl,'interactions','ResponseVar','amplitude','PredictorVars',{'pCorrectChange', 'pCorrect_previous'});
    ...
    figname = [save_filedir 'pcorrect_change_betas.png'];
outputname = [save_filedir 'pcorrect_change_results.mat'];
